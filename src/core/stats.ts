...
export class Stats {
  public apiRequests: number = 0;
  public apiSuccess: number = 0;
  public apiErrors: number = 0;
  public apiTimeSpent: number = 0;
  public toolCalls: number = 0;
  public toolErrors: number = 0;
  public toolTimeSpent: number = 0;
  public messagesSent: number = 0;
  public tokensProcessed: number = 0;
  public compactions: number = 0;
  public promptTokens: number = 0;
  public completionTokens: number = 0;
  public currentPromptSize: number = 0;
  public currentPromptSizeEstimated: boolean = false;
  public lastUserPrompt: string = '';
  public usageInfos: Array<{ time: number; usage: any }> = [];
   ...
   */
  setCurrentPromptSize(size: number, estimated: boolean = false): void {
  ...
  printStats(): void {
    console.log('\n=== Session Statistics ===');
    console.log(`API Requests: ${this.apiRequests} (Success: ${this.apiSuccess}, Errors: ${this.apiErrors})`);
    ...
    if (this.currentPromptSize > 0) {
      ...
      console.log(`Final Context Size: ${this.currentPromptSize.toLocaleString()}${estimated}`);
    }
    console.log('========================');
  }
