...
export class MarkdownColorizer {
  private _inCode: boolean = false;
  private _codeTickCount: number = 0;
  private _inStar: boolean = false;
  private _starCount: number = 0;
  private _atLineStart: boolean = true;
  private _inHeader: boolean = false;
  private _inBold: boolean = false;
  private _consecutiveCount: number = 0;
  private _canBeBold: boolean = false;
